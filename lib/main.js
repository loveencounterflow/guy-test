...
/* TAINT preliminary handling of arguments */
    ...
    _report() {
      ...
      //.......................................................................................................
      show_totals = () => {
        whisper('Ωgt___4 ' + this.cfg.prefix, line);
        whisper('Ωgt___5 ' + this.cfg.prefix, reverse(GUY.trm[color]('*'.padEnd(20), this.totals)));
        whisper('Ωgt___6 ' + this.cfg.prefix, line);
        return null;
      };
      //.......................................................................................................
      whisper();
      whisper('Ωgt___7 ' + this.cfg.prefix, line);
      whisper('Ωgt___8 ' + this.cfg.prefix, gold('                        🙤 GUY TEST 🙦'));
      ...
      for (key in ref1) {
        ...
        whisper('Ωgt__10 ' + this.cfg.prefix, blue(key.padEnd(20), stats));
      }
      show_totals();
      repeat_totals = false;
      ref2 = this.warnings;
      for (sub_ref in ref2) {
        ...
        for (i = 0, len = messages.length; i < len; i++) {
          message = messages[i];
          whisper('Ωgt__11 ' + this.cfg.prefix, red(sub_ref), reverse(red(` ${message} `)));
        }
      }
      if (repeat_totals) {
        show_totals();
