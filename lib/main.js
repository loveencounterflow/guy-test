...
(function() {
  //###########################################################################################################
  var ASYNC, CND, DIFF, alert, badge, debug, diff, echo, help, info, is_callable, log, njs_domain, rpr, urge, warn, whisper,
    splice = [].splice;
  ...
  module.exports = function(x, settings = null) {
    ...
    new_result_handler_and_tester = function(test_name) {
      ...
      RH.on_error = function(delta, checked, error) {
        ...
        entry['message'] = (ref = error != null ? error['message'] : void 0) != null ? ref : "µ98841 Guy-test: received `null` as error";
