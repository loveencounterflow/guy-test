(function() {
  'use strict';
  var ASYNC, CND, INTERTYPE, alert, all_keys_of, badge, debug, echo, equals, help, info, inspect, intertype, is_callable, isa, jr, log, njs_domain, rpr, rpr_settings, size_of, type_of, urge, validate, warn, whisper, xdebug,
    splice = [].splice;
  ...
  ({isa, validate, type_of, size_of, equals, all_keys_of} = intertype.export());
