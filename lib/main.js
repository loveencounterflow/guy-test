...
/* TAINT preliminary handling of arguments */
      for (i = 0, len = tests.length; i < len; i++) {
        ...
        switch (true) {
          ...
          default:
            ...
            this._increment_fails('test', ref);
      ...
      for (i = 0, len = tests.length; i < len; i++) {
        ...
        switch (true) {
          ...
          default:
            ...
            throw new Error(`Ωgt___3 expected a test, got a ${type_of(test)}`);
        }
      }
      return results;
    }
    ...
    // when isa.asyncfunction test then null
      ...
      //---------------------------------------------------------------------------------------------------------
    _report(cfg) {
      var blue, color, gold, i, key, len, message, messages, prefix, red, ref1, ref2, stats, sub_ref;
