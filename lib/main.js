(function() {
  'use strict';
  var GUY, Intertype, Test, WG, _Assumptions, _jkequals, _set_or_map_contains, _sets_or_maps_are_equal, alert, create, debug, echo, equals, help, hide, info, inspect, isa, j, log, nameit, plain, praise, reverse, rpr, to_width, type_of, types, urge, validate, warn, whisper;
...
/* TAINT preliminary handling of arguments */
  ...
  equals = function(a, b) {
    ...
    if ((type_of_a === 'set') || (type_of_a === 'map')) {
      return _sets_or_maps_are_equal(a, b);
    }
    return _jkequals(a, b);
  };

  //...........................................................................................................
  _set_or_map_contains = function(set, entry) {
    var element;
    for (element of set) {
  ...
  //...........................................................................................................
  _sets_or_maps_are_equal = function(a, b) {
    var element;
    if (a.size !== b.size) {
    ...
    for (element of a) {
      if (!_set_or_map_contains(b, element)) {
        return false;
      }
    }
    return true;
