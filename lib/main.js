  ...
  Assumptions = class Assumptions {
    ...
    eq(f, matcher) {
      ...
      if (this._.equals(result, matcher)) {
        //.......................................................................................................
        return this.pass(j(ref, 'Ωgt___5'), 'eq');
      }
      //.......................................................................................................
    ...
    throws(f, matcher) {
      ...
      try {
        //.......................................................................................................
        urge(`^${ref}^ \`throws()\` result of call:`, f.call(this, this));
      } catch (error1) {
        error = error1;
        if (matcher == null) {
          this.pass(`${ref}.Ωgt___9`, 'error ok', error.message);
          return null;
        }
        //.....................................................................................................
        switch (matcher_type = this._._match_error(error, matcher)) {
          case true:
            this.pass('Ωgt__10', 'error ok', error.message);
            break;
          case false:
            urge(`^${ref}.Ωgt__11^ error        `, reverse(error.message));
            /* TAINT to be replaced */            warn(`^${ref}.Ωgt__12^ doesn't match`, reverse(rpr(matcher)));
            this./* TAINT to be replaced */fail('Ωgt__13', 'neq', `error ${rpr(error.message)} doesn't match ${rpr(matcher)}`);
            break;
          default:
            this.fail('Ωgt__14', 'type', `expected a regex or a text, got a ${matcher_type}`);
        }
      }
      //.......................................................................................................
      if (error == null) {
        this.fail('Ωgt__15', 'noerr', "expected an error but none was thrown");
      }
      //.......................................................................................................
      return null;
    }
    ...
    async async_throws(f, matcher) { // new Promise ( resolve, reject ) =>
      ...
      * otherwise an `error` will be caught;
      ...
      try {
        ...
        //.....................................................................................................
        if (matcher == null) {
          this.pass('Ωgt__16', 'error ok', `did throw ${rpr(error.message)}`);
          return null;
        }
        //.....................................................................................................
        switch (matcher_type = this._._match_error(error, matcher)) {
          ...
          case false:
            ...
            this.fail('Ωgt__20', 'error nok', `did throw but not match ${rpr(error.message)}`);
            break;
          default:
            this.fail('Ωgt__21', 'fail', `expected a regex or a text for matcher, got a ${matcher_type}`);
        }
      }
      //.......................................................................................................
      if (error == null) {
        this.fail('Ωgt__22', 'missing', `expected an error but none was thrown, instead got result ${rpr(result)}`);
      }
      //.......................................................................................................
      return null;
    }
...
/* TAINT preliminary handling of arguments */
    ...
    _report() {
      ...
      //.......................................................................................................
      show_totals = () => {
        whisper('Ωgt__31 ' + this.cfg.prefix, line);
        whisper('Ωgt__32 ' + this.cfg.prefix, reverse(GUY.trm[color]('*'.padEnd(20), this.totals)));
        whisper('Ωgt__33 ' + this.cfg.prefix, line);
        return null;
      };
      //.......................................................................................................
      whisper();
      whisper('Ωgt__34 ' + this.cfg.prefix, line);
      whisper('Ωgt__35 ' + this.cfg.prefix, gold('                        🙤 GUY TEST 🙦'));
      whisper('Ωgt__36 ' + this.cfg.prefix, line);
      ...
      for (key in ref1) {
        ...
        whisper('Ωgt__37 ' + this.cfg.prefix, blue(key.padEnd(20), stats));
      }
      show_totals();
      repeat_totals = false;
      ref2 = this.warnings;
      for (sub_ref in ref2) {
        ...
        for (i = 0, len = messages.length; i < len; i++) {
          message = messages[i];
          whisper('Ωgt__38 ' + this.cfg.prefix, red(sub_ref), reverse(red(` ${message} `)));
        }
      }
      if (repeat_totals) {
        show_totals();
