...
(function() {
  ...
  module.exports = function(x, settings) {
    var check_count, error_handler, fail_count, failures, new_tester, pass_count, report, run, supply_caller_to_error, test_count;
    if (settings == null) {
      settings = null;
    }
    ...
    fail_count = 0;
    failures = {};
    error_handler = function(test_name, error) {
      var entry, target;
      fail_count += 1;
      entry = error['caller'];
    ...
    supply_caller_to_error = function(delta, checked, error) {
      var caller;
      if (error == null) {
        delta += +1;
      }
    ...
    new_tester = function(test_name) {
      ...
      R.fail = function(message) {
        ...
        return error_handler(test_name, supply_caller_to_error(1, true, new Error(message)));
      };
      return R;
    };
    run = function() {
